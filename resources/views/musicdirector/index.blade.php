@extends('layouts.app')
@section('content')
<script src="{{ url('public/js/controller/musicdirectorController.js') }}"></script>
      ...
      <div class="panel panel-default">
            ...
            <table role="grid" datatable="ng" class="table table-responsive">
              ...
              <tbody>
                <tr ng-repeat="row in data">
                  ...
                  <td><% row.gender %></td> -->
                  <td>
                    <a class="btn btn-link" ng-click="editItem(row.id,'{{ url('/musicdirector/save') }}')">View</a>
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-lg-12">
              <div class="panel panel-default">
                  <div class="panel-heading">Music Director <button class="btn btn-danger" ng-click="new()">Reset</button> </div>
                  <div class="panel-body">
                    @if (isset($message))
