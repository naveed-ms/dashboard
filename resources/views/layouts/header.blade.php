<head>
	...
	<!-- start: CSS -->
	<link id="bootstrap-style" href="{{ url('/public/css/bootstrap.min.css') }}" rel="stylesheet">
	<link href="{{ url('/public/css/bootstrap-responsive.min.css') }}" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/t/bs-3.3.6/dt-1.10.11/datatables.min.css"/>
	<link id="base-style" href="{{ url('/public/css/style.css') }}" rel="stylesheet">
	<link id="base-style-responsive" href="{{ url('/public/css/style-responsive.css') }}" rel="stylesheet">
	<!-- Fonts -->
	...
	<!-- end: Favicon -->
		...
		<script src="{{ url('/public/js/jquery-migrate-1.0.0.min.js') }}"></script>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{URL::to('/index')}}"><span>Bestsongs.pk</span></a>
